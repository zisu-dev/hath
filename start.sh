...
java -jar HentaiAtHome.jar --cache-dir=/hath/data/cache --data-dir=/hath/data/data --download-dir=/hath/data/download --log-dir=/hath/data/log --temp-dir=/hath/data/temp
